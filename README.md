...
14. [IVRs (URAs)](#ivrs-uras)
15. [IVR Options (Opções)](#ivr-options-opções)
...
Realiza soft delete — o dialplan é regenerado imediatamente, removendo a extensão do Asterisk, e o AGI também filtra `active = 1 AND deleted_at IS NULL`.
...
**By: Israel Azevedo**#  Asterisk REST API - Documentação Completa
